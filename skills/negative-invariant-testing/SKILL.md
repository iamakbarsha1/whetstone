...
- **Name the invariant in the failure message.** A structural test that fires
  ...
  crossed a designed line, not hit a lint quirk. *(Illustrative: A guard against
...
- **Prefer the narrowest structural signal.** Trip on the specific forbidden
  ...
  gets deleted, and then the invariant is unprotected again. *(Illustrative: A "never opens
